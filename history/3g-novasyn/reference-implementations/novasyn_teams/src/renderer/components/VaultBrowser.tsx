      ...
      <div className="bg-slate-800 border border-slate-600 rounded-xl w-[900px] h-[600px] shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-2 px-4 py-2 border-b border-slate-700 bg-slate-800/50">
          <input
            ...
            className="flex-1 bg-slate-700 border border-slate-600 rounded px-3 py-1.5 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-blue-500"
          />
          <select
            value={filterType}
          ...
          <button onClick={loadItems} className="bg-teal-600 hover:bg-teal-500 text-white text-sm px-3 py-1.5 rounded">
            Search
          </button>
        </div>
                  ...
                  <div className="flex items-center gap-2">
                    {onImport && (
                      <button
                        ...
                        className="bg-teal-600 hover:bg-teal-500 text-white text-sm px-3 py-1 rounded"
                      >
                        Import
                      </button>
                    )}
                      ...
                      try {
                        ...
                        return (
                          <div className="space-y-3">
                            <div>
                              <div className="text-xs font-medium text-teal-400 mb-1">User:</div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="space-y-1">
                      {provenance.map((p, i) => (
                        <div
                          key={p.id}
                          className={`flex items-center gap-2 text-xs ${p.id === selectedItem.id ? 'text-teal-400' : 'text-gray-400'}`}
                        >
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <input
                      ...
                      className="flex-1 bg-slate-700 border border-slate-600 rounded px-2 py-1 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-teal-500"
                    />
                    <button
