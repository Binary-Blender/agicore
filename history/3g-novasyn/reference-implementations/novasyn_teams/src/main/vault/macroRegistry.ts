...
const APP_ID = 'novasyn-teams';
const APP_DISPLAY_NAME = 'NovaSyn Teams';
...
function getTeamsMacros(): Record<string, MacroDefinition> {
  return {
    'teams.send_message': {
      description: 'Send a message to a channel',
      input: { channelId: 'string', content: 'string', messageType: 'string?' },
      output: { messageId: 'string', status: 'string' },
    },
    'teams.create_channel': {
      description: 'Create a new channel in a team',
      input: { teamId: 'string', name: 'string', description: 'string?' },
      output: { channelId: 'string', status: 'string' },
    },
    'teams.summarize_channel': {
      description: 'Generate an AI summary of recent channel messages',
      input: { channelId: 'string', messageCount: 'number?' },
      output: { summary: 'string', messageCount: 'number' },
    },
  };
}
