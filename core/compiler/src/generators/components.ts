...
function generateViewComponent(view: ViewDecl, entity: EntityDecl | undefined, ast: AgiFile): string {
  ...
  switch (view.layout) {
    ...
    case 'kanban':          return generateKanbanView(view, entity, ast);
    case 'form':
    case 'detail':
    case 'custom':
...
function generateKanbanView(view: ViewDecl, entity: EntityDecl | undefined, _ast: AgiFile): string {
