...
export enum TokenType {
  ...
  NBVE_WINDOW = 'NBVE_WINDOW',
  APPROVAL_AUTHORITY = 'APPROVAL_AUTHORITY',
  ANDON_RESPONDER_KW = 'ANDON_RESPONDER_KW',
  IMPROVEMENT_REASONER_KW = 'IMPROVEMENT_REASONER_KW',
  LEDGER = 'LEDGER',
  ...
  // COGNITION_ROLE keywords
  COGNITION_ROLE_KW = 'COGNITION_ROLE_KW',
  RESPONSIBILITIES_KW = 'RESPONSIBILITIES_KW',
  QC_PROFILE_KW = 'QC_PROFILE_KW',
  ESCALATE_TO_KW = 'ESCALATE_TO_KW',
  MODEL_HIERARCHY_KW = 'MODEL_HIERARCHY_KW',
  PROMOTION_POLICY_KW = 'PROMOTION_POLICY_KW',
  FALLBACK_POLICY_KW = 'FALLBACK_POLICY_KW',
  ROLE_KW = 'ROLE_KW',

  // ESCALATION_CHAIN keywords
  ESCALATION_CHAIN_KW = 'ESCALATION_CHAIN_KW',
  ESCALATE_ON_KW = 'ESCALATE_ON_KW',
  DEESCALATE_ON_KW = 'DEESCALATE_ON_KW',
  SPC_VIOLATION_KW = 'SPC_VIOLATION_KW',
  STABILITY_WINDOW_KW = 'STABILITY_WINDOW_KW',
  ERROR_RATE_KW = 'ERROR_RATE_KW',
  ...
  CRITERIA_KW = 'CRITERIA_KW',
  CONSENSUS_KW = 'CONSENSUS_KW',
  MIN_EVALUATORS_KW = 'MIN_EVALUATORS_KW',
...
const KEYWORDS: Record<string, TokenType> = {
  ...
  SIGNATURES: TokenType.SIGNATURES,
  CONSUMERS: TokenType.CONSUMERS,
  PRODUCERS: TokenType.PRODUCERS,
  ...
  AUTO_DEPLOY: TokenType.AUTO_DEPLOY,
  REGRESSION_SUITE: TokenType.REGRESSION_SUITE,
  MONITORING_WINDOW: TokenType.MONITORING_WINDOW,
  NBVE_WINDOW: TokenType.NBVE_WINDOW,
  APPROVAL_AUTHORITY: TokenType.APPROVAL_AUTHORITY,
  ANDON_RESPONDER: TokenType.ANDON_RESPONDER_KW,
  IMPROVEMENT_REASONER: TokenType.IMPROVEMENT_REASONER_KW,
  ...
  COGNITION_ROLE: TokenType.COGNITION_ROLE_KW,
  RESPONSIBILITIES: TokenType.RESPONSIBILITIES_KW,
  QC_PROFILE: TokenType.QC_PROFILE_KW,
  ESCALATE_TO: TokenType.ESCALATE_TO_KW,
  MODEL_HIERARCHY: TokenType.MODEL_HIERARCHY_KW,
  PROMOTION_POLICY: TokenType.PROMOTION_POLICY_KW,
  FALLBACK_POLICY: TokenType.FALLBACK_POLICY_KW,
  ROLE: TokenType.ROLE_KW,
  ESCALATION_CHAIN: TokenType.ESCALATION_CHAIN_KW,
  ESCALATE_ON: TokenType.ESCALATE_ON_KW,
  DEESCALATE_ON: TokenType.DEESCALATE_ON_KW,
  SPC_VIOLATION: TokenType.SPC_VIOLATION_KW,
  STABILITY_WINDOW: TokenType.STABILITY_WINDOW_KW,
  ERROR_RATE: TokenType.ERROR_RATE_KW,
  ...
  SPC_FLOOR: TokenType.SPC_FLOOR,
  DEFECT_RATE: TokenType.DEFECT_RATE,
  RETRY_RATE: TokenType.RETRY_RATE,
  ESCALATION_RATE: TokenType.ESCALATION_RATE,
  QC_MESH: TokenType.QC_MESH_KW,
  EVALUATORS: TokenType.EVALUATORS_KW,
  CRITERIA: TokenType.CRITERIA_KW,
  CONSENSUS: TokenType.CONSENSUS_KW,
