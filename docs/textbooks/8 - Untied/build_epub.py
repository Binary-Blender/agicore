#!/usr/bin/env python3
"""
Build script for: Untied — A TAO Future Case Study
Author: Christopher Bender
Publisher: AI WIN-WIN Institute
Business fable about two software consultancies, the AI-augmented exodus of their
employees to solo founder roles, and the divergent leadership responses that determine
which firm survives. Third book of the TAO trilogy of practice.
"""
...
OUTPUT_FILE = os.path.join(BOOK_DIR, "untied.epub")
...
PUBLISHER = "AI WIN-WIN Institute"
LANGUAGE = "en"
IDENTIFIER = "ai-win-win-untied-novel-001"

PARTS = [
    ("Part I: The Exodus", [1, 2, 3, 4]),
    ("Part II: The Divergence", [5, 6, 7, 8, 9]),
    ("Part III: The Equilibrium", [10, 11, 12, 13]),
]

CHAPTER_TITLES = {
    1:  "The First Wave",
    2:  "The Other Office",
    3:  "The Attic in Cincinnati",
    4:  "The Two Reactions",
    5:  "Karen's Memo",
    6:  "Stillwater's First Move",
    7:  "Three Rivers",
    8:  "The Solo Years",
    9:  "Partners Not Resources",
    10: "Hartwell, Eighteen Months In",
    11: "Damon's Return",
    12: "The Other Three",
    13: "The Equilibrium",
}
...
def main():
    ...
    book.add_metadata('DC', 'description', f"{SUBTITLE}. A business novel about two software consultancies, the AI-augmented exodus of their best employees into solo founder roles, and the divergent leadership responses that determine which firm survives. Third book of the TAO trilogy of practice (Anchor, Multiplied, Untied).")
    for s in ('Business Fiction', 'Artificial Intelligence', 'Future of Work', 'Software Consulting'):
...
<p>&nbsp;</p>
<p>This is a work of fiction. Hartwell Digital, Stillwater Software, and all
characters and events in this book are products of the author's imagination.
Any resemblance to actual companies, persons, or events is coincidental.</p>
<p>&nbsp;</p>
<p>Third book of the TAO trilogy of practice. Companion to <em>Anchor</em> (literary
case study) and <em>Multiplied</em> (implementation novel).</p>
<p>&nbsp;</p>
