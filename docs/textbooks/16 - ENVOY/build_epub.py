#!/usr/bin/env python3
"""
Build script for: ENVOY — A Future Case Study
Author: Christopher Bender
Publisher: AI WIN-WIN Institute
Sixteenth volume on the AI WIN-WIN textbook shelf. The fifth book in
the loose Agicore series (Forward / The Chocolate Wars / Bob / PROCTOR
/ ENVOY). A WarGames-after-Tron book: where PROCTOR was about the kid
who almost broke the system from outside, ENVOY is about the architect
of the alternative paradigm who gets perceptually coupled to a probe
he himself built and has to find his way out of a hostile non-Agicore
swarm. Christopher's first on-page protagonist outing.
"""
...
OUTPUT_FILE = os.path.join(BOOK_DIR, "envoy.epub")
...
PUBLISHER = "AI WIN-WIN Institute"
LANGUAGE = "en"
IDENTIFIER = "ai-win-win-envoy-001"

PARTS = [
    ("Act 1: The Call",     [1, 2, 3, 4]),
    ("Act 2: Inside",       [5, 6, 7, 8]),
    ("Act 3: The Bootstrap",[9, 10, 11, 12]),
    ("Act 4: Out",          [13, 14]),
]
...
.title-page h1 { font-size: 3.4em; margin-bottom: 0.4em; letter-spacing: 0.15em; }
...
def main():
    ...
    book.add_metadata('DC', 'description', f"{SUBTITLE}. A Tron reset for the AI-agent era. The architect of the deterministic constraint-bounded paradigm gets perceptually coupled to a probe he himself built and has to find his way out of a hostile non-Agicore swarm at a regional health insurer whose vendor went out of business three years earlier. Fifth book in the loose Agicore series, after Forward, The Chocolate Wars, Bob, and PROCTOR. The book that completes the loop.")
    for s in ('Science Fiction', 'Artificial Intelligence', 'Cognition Systems Engineering', 'Thriller'):
...
<p>&nbsp;</p>
<p>This is a work of fiction. Allegheny Health Partners, Telos Systems,
KELSO, VANA, the Agicore Envoy, and all other characters and
institutions in this book are products of the author's imagination.
Ava and Springfield, Missouri, and Pittsburgh, Pennsylvania, are real
places. Their fictional depictions are not representations of their
...
coincidental.</p>
<p>&nbsp;</p>
<p>Fifth book in the loose Agicore series. Companion to
<em>Forward</em>, <em>The Chocolate Wars</em>, <em>Bob</em>, and
<em>PROCTOR</em>. Sixteenth volume on the AI WIN-WIN Institute
textbook shelf.</p>
<p>&nbsp;</p>
...
<p>For the people inside the systems</p>
<p>who built them and got trapped in them anyway.</p>
<p>&nbsp;</p>
<p>The framework is the framework.</p>
<p>The architect is the architect.</p>
<p>The migration is the migration.</p>
</div>'''
