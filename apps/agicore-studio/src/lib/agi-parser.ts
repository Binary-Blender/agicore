// MVP .agi → workflow parser.
//
// Scope: WORKFLOW + its NODE / EDGE declarations only. Everything else
// in the .agi file is currently ignored (APP, ENTITY, ACTION, etc.) —
// MVP only authors WORKFLOW. Alpha replaces this with a full Lezer-based
// parser shared with the editor's autocomplete layer.
//
...
// emit conventions, weird things may happen — by design for MVP.
